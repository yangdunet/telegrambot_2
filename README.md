...
[English](https://github.com/YanSi/Telegram-interactive-bot/blob/master/README.en.md) | [示例机器人](https://t.me/CustomerConnectBot) | [示例后台](https://t.me/YanSiCMSGroup)
...
- 本产品基于Apache协议开源。
- 作者 颜思( [@MrYanSi](https://t.me/MrYanSi) )是一个苦逼程序员，不是煤场奴工，有问题别太理直气壮的跑来下命令。
...
- 实在实在实在搞不定部署，找  [@MrYanSi](https://t.me/MrYanSi)  同学付费部署……

# 详细部署文档

[颜思同学的知识库](https://yansi.uk/docs/tutor/telegram-interactive-bot/)
